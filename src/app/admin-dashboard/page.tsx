        ...
        <section className="layout-container space-y-6">
          ...
          {error && (
            <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
              ...
              <button onClick={() => window.location.reload()} className="btn btn-sm btn-outline mt-2">
                Retry
              </button>
            </div>
          )}
            ...
            <>
              <section className="section-card">
                <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-6">
                  ...
                  <Metric title="Active Students" value={performanceData.activeStudents} />
              ...
              {overview?.attempts && <StudentAnalyticsExplorer students={students} attempts={overview.attempts} theme="admin" />}
              ...
              <section className="section-card">
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                  <Link href="/admin-dashboard/students" className="side-card transition hover:shadow-md">
                    Student Management
                  </Link>
                  <Link href="/admin-dashboard/staff" className="side-card transition hover:shadow-md">
                    Staff Credentials
                  </Link>
              ...
              <section className="grid gap-6 md:grid-cols-3 mt-6">
                <Link href="/admin-dashboard/students" className="section-card transition hover:shadow-lg">
                  <p className="text-lg font-semibold text-slate-900">Manage Students</p>
                  <p className="mt-2 text-sm text-slate-600">Add, edit, delete, or bulk import students with CSV support.</p>
                </Link>
